...
| ![](results/banana_cat_is_crying.gif)<br>`"banana cat is crying"` | ![](results/cucumber_cat_is_crying_with_I'm_Fine_text.gif)<br>`"cucumber cat is crying with I'm Fine text"` | ![](results/Tomato_penguin_is_crying.gif)<br>`"Tomato penguin is crying"` | ![](results/eggplant cat is crying.gif)<br>`"eggplant cat is crying"` | ![](results/banana_elephant_is_crying_with_Oh_Noooo_text.gif)<br>`"banana elephant is crying with Oh Noooo text"` |
